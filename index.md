...
<div class="row">
    <div class="card" style="col-sm">
        <img src="https://pbs.twimg.com/media/Ec46drCXsAcvy3O.jpg" class="card-img-top" alt="Tim">
        <div class="card-body">
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
    </div>
    <div class="card" style="col-sm">
        <img src="https://pbs.twimg.com/media/Ec46drCXsAcvy3O.jpg" class="card-img-top" alt="Sam">
        <div class="card-body">
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
    </div>
    <div class="card" style="col-sm">
        <img src="https://pbs.twimg.com/media/Ec46drCXsAcvy3O.jpg" class="card-img-top" alt="Zach">
        <div class="card-body">
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        </div>
    </div>
